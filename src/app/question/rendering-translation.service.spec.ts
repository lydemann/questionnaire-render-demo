...
import { RenderingTranslationService, comboboxOptionsThreshold } from './rendering-translation.service';
import { Question, AnswerOption } from '../questionnaire.model';
...
describe('RenderingTranslationService', () => {
  ...
  describe('getRenderingForQuestion', () => {
    ...
    it('should should return a radio rendering when the answerType is SELECTONE and' +
    ...
    it('should should return a checkbox rendering when the answerType is SELECTMULTI and' +
    ...
    describe('combobox', () => {
      it('should should return a combobox rendering when the answerType is SELECTONE and' +
        ...
        it('should should return a combobox rendering when the answerType is SELECTMULTI and' +
        'amount of answerOptions are greater or equeal combobox options threshold', () => {
          const question = new Question();
          question.answerType = 'SELECTMULTI';
          for (let index = 0; index < comboboxOptionsThreshold + 2; index++) {
